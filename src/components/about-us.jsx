          ...
          <div className="max-w-8xl w-full space-y-8">
            <div className="bg-gray-100 shadow-md rounded-lg p-8">
              <div className="space-y-6">
                ...
                <div>
                  <h4 className=" text-gray-800">About Higheringco</h4>
                  <p className="mt-2 text-gray-600">
                    Welcome to Higheringco, where knowledge meets innovation.
                ...
                <div>
                  ...
                  <p className="mt-2 text-gray-600">
                    Higheringco was born out of a shared vision to revolutionize
                    the way people learn. What started as a small initiative has
                    now grown into a dynamic platform offering cutting-edge
                    online courses to students worldwide.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2 text-gray-600">
                    When you choose Higheringco, you're not just investing in a
