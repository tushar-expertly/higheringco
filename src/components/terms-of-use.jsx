    ...
    <Layout>
      <div className="bg-gray-100 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            Content on the Higheringco website may be protected by U.S. and
          ...
          <p className="mb-4">
            ...
            Higheringco strives for accuracy but cannot guarantee the
            reliability of third-party information. Higheringco is not
            responsible for actions taken based on this information or for any
            resulting consequences.
          </p>
          {/* <p className="mb-4">External Links</p> */}
          <p className="mb-4">
            Higheringco’s website may include links to external sites maintained
            by other organizations. These links are provided to offer relevant
            information to visitors. The presence of a link does not imply
            endorsement by Higheringco. Links may be removed or updated at any
            time without notice.
          </p>
          <p className="font-semibold mb-2">External Links</p>
          <p className="mb-4">
            If issues arise with linked external sites, please contact the
            respective organizations. Higheringco is not responsible for the
